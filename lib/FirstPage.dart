...
//var random = new Random();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(backgroundColor: Colors.blue, title: Text('Simple Level', style: TextStyle(color: Colors.blue,  fontWeight: FontWeight.bold,fontSize: 50.0),),),
        drawer: Drawer(
          child: MainDrawer(),
        ),
        body: Padding(
          ...
          child: Column(
            children: <Widget>[
              Padding(
                ...
                child: Text('Total Dice = '+ (randomIntForDiceOne + randomIntForDiceTwo + 2).toString(),
                  style: TextStyle(
                    fontSize: 40,
